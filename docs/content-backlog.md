...
| SD-017 | 2026-08-15 | Fill empty stub: Sharding Strategies | fill-stub | system-design/algorithms/sharding-strategies.md | Title-only stub, indexed but unfilled. | Backlog | - | gap-scan 2026-08-15 | p1 |
| SD-022 | 2026-08-15 | Fill empty stub: Distributed File System | fill-stub | system-design/components/distributed-file-system.md | Title-only stub, indexed but unfilled. | Backlog | - | gap-scan 2026-08-15 | p1 |
...
| SD-025 | 2026-08-15 | Fill empty stub: Search | fill-stub | system-design/components/search.md | Title-only stub, indexed but unfilled. | Backlog | - | gap-scan 2026-08-15 | p1 |
