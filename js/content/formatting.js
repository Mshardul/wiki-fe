...
const VAR_MAP = {
  ...
  L: "length",
  S: "space",
  // intentionally omitted: e, i, j, x, y, z - too ambiguous to substitute
};
  ...
  contentEl.querySelectorAll(".katex-display").forEach((block) => {
    ...
    btn.addEventListener("click", (e) => {
      ...
      try {
        ...
        // katex.renderToString is safe - output is generated by the KaTeX library from a LaTeX string we control
