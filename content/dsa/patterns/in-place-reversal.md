...
<!-- PA2: the mechanic + a REAL diagram (pointer rewiring, three-pointer technique). -->
...
<!-- PA5 (advisory): common twists (reverse k-groups, reverse between positions m and n, palindrome check). -->
