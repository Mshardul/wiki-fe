...
<!-- PA1 (weight 3, the heart). THREE labeled parts, all concrete — any missing/vague caps the score at 5:
     ...
     (c) Not to be confused with — name ≥1 neighbor pattern (general DP, bitmask DP) + the distinction in one sentence. -->

## How it works

<!-- PA2: the mechanic + a REAL diagram (state transition diagram). -->
...
<!-- PA5 (advisory): common twists (stock buy/sell with cooldown, k transactions, transaction fee). -->

## CP-primitives

<!-- PA11 (gated): ≥2 contest-flavored tricks/variants. Each with one-line "why for CP". -->
