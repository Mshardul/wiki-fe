...
<!-- DS5 (advisory): ≥1 real variant (e.g. implicit treap for sequence operations). -->
...
<!-- DS7: ≥2 interview traps, including ≥1 CP-flavored where relevant (implicit treap for range ops, priority collision). -->
